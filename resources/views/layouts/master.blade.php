            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                 <a href="{{route('insumo.create')}}" class="nav-link text-dark">
                                            <i class="nav-icon fas fa-edit"></i>
                                            <p>Ingreso</p>
                    ...
                    @if(auth()->user()->role === 'admin')
                        <li class="nav-item">
                            <a href="{{ route('register.mayordomo.form') }}" class="nav-link text-success">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('recolecta.create')}}" class="nav-link text-dark">
